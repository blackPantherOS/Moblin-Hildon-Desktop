...
GtkWidget *create_dialog_message_question(GtkWidget *window, const gchar *title, gchar *message, ...)
{
	va_list ap;
	GtkWidget *dialog;
	gchar *str;
...
gint run_dialog_message_question(GtkWidget *window, const gchar *title, gchar *message, ...)
{
	va_list ap;
	GtkWidget *dialog;
	gchar *str;
	...
	dialog = create_dialog_message_question(window, title, str);
	g_free(str);
	...
	const gchar *description, const gchar *copyright, gchar *iconpath)
{
	...
	str = g_strdup_printf("About %s", PACKAGE_NAME);
