...
GtkWidget *create_menu_bar(GtkWidget *window, StructData *sd)
{
        ...
        gtk_widget_remove_accelerator(
                gtk_item_factory_get_widget(ifactory, "/Edit/Cut"),
                accel_group, GDK_X, GDK_CONTROL_MASK);
        gtk_widget_remove_accelerator(
                gtk_item_factory_get_widget(ifactory, "/Edit/Copy"),
                accel_group, GDK_C, GDK_CONTROL_MASK);
        gtk_widget_remove_accelerator(
                gtk_item_factory_get_widget(ifactory, "/Edit/Paste"),
