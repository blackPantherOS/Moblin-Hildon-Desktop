...
static void nma_menu_add_devices (GtkWidget *menu, NMApplet *applet)
{
	...
	if (!applet->device_list)
	{
		if (applet->nm_state != NM_STATE_CONNECTED)
          ...
          // Removed call to this funtion for moblin. This removes 
          // adding Manual Configuration item to the nm-applet 
          // pulldown menu
	...
	if (n_wireless_interfaces > 0 && applet->wireless_enabled)
	{
		...
		// Removed 'creation of new wireless network menu item' for moblin
		//nma_menu_add_create_network_item (menu, applet);
	}
	// Removed call to this funtion for moblin. This removes 
	// adding Manual Configuration item to the nm-applet pulldown menu
