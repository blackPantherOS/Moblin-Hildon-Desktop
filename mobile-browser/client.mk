...
$(warning MOZ_MIDBROWSER is obsolete.)
MOZ_MODULE_LIST += $(MODULES_midbrowser)
# $(error MOZ_MIDBROWSER is obsolete, use MOZ_CO_PROJECT=midbrowser and --enable-application=midbrowser)
endif
