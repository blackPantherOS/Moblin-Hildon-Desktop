...
function openPreferences(paneID)
{
  ...
  var features = "chrome,titlebar,toolbar, help=no, centerscreen" + (instantApply ? ",dialog=no" : ",modal");
#else
...
#ifdef MOZ_MIDBROWSER
    openDialog("chrome://midbrowser/content/preferences/preferences.xul",
#else
