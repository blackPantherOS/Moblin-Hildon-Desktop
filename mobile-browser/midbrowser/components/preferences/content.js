...
var gContentPane = {
  ...
  _showExceptions: function (aPermissionType)
  {
    ...
    document.documentElement.openWindow("Browser:Permissions",
                                        "chrome://midbrowser/content/preferences/permissions.xul",
                                        "", params);
  },
  ...
  readLoadImages: function ()
  {
    ...
    var button = document.getElementById("loadImagesExceptionButton");
    if(pref.value==1 || pref.value == 3)
    {
  ...
  {
    document.documentElement.openSubDialog("chrome://midbrowser/content/preferences/advanced-scripts.xul",
                                           "", null);  
  },
  ...
  {
    document.documentElement.openSubDialog("chrome://midbrowser/content/preferences/fonts.xul",
                                           "", null);
  },
  ...
  {
    document.documentElement.openSubDialog("chrome://midbrowser/content/preferences/colors.xul",
                                           "", null);  
  },
  ...
  {
    document.documentElement.openSubDialog("chrome://midbrowser/content/preferences/languages.xul",
                                           "", null);
  }
