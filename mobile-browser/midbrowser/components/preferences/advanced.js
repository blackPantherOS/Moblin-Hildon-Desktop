...
var gAdvancedPane = {
  ...
  {
    document.documentElement.openSubDialog("chrome://midbrowser/content/preferences/connection.xul",
                                           "", null);
  },
  ...
  checkNow: function ()
  {
    var shellSvc = Components.classes["@mozilla.org/midbrowser/shell-service;1"]
