...
var gSecurityPane = {
  ...
  _userAgreedToPhishingEULA: function (providerNum)
  {
    ...
    if (!pref.value) {
      ...
      document.documentElement.openSubDialog("chrome://midbrowser/content/preferences/phishEULA.xul",
                                             "resizable", rv);
  ...
  {
    document.documentElement.openSubDialog("chrome://midbrowser/content/preferences/securityWarnings.xul",
                                           "", null);
  }
